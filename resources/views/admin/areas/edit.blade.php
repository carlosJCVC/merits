    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Editar de Area</li>
            </ol>
        </section>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <form id="register-form" action="{{ route('admin.areas.update', $area->id) }}" method="POST" class="validate-form form-horizontal" autocomplete="off">
                                {{ method_field('PUT')}}
                                {{ csrf_field() }}
                                ...
                                <div class="box-footer text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <a href="{{ route('admin.areas.index')  }}" class="btn100-form">Cancelar</a>
                                        </div>
